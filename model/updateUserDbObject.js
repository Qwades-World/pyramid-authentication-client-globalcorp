...
exports.UpdateUserDbObject = void 0;
/**
* The object used to update a database authentication user.
*/
var UpdateUserDbObject = /** @class */ (function () {
    function UpdateUserDbObject() {
        /**
        * Value used to determine the type of the item receiving, use the class name
        */
        this['inheritanceType'] = 'UpdateUserDbObject';
    }
    UpdateUserDbObject.getAttributeTypeMap = function () {
        return UpdateUserDbObject.attributeTypeMap;
    };
    UpdateUserDbObject.discriminator = undefined;
    UpdateUserDbObject.attributeTypeMap = [
        {
            "name": "lastName",
            "baseName": "lastName",
            "type": "string"
    ...
    return UpdateUserDbObject;
}());
exports.UpdateUserDbObject = UpdateUserDbObject;
